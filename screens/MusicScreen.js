...
const MUSIC_DATA = {
  SONO: [
    { id: 'sono-1', title: 'Clair de Lune', artist: 'Debussy', bpm: 50, driveId: '1IcvqZbYMc50TF08Yewkn-qKc4-eFL0sr', evidence: 'Domínio público' },
    { id: 'sono-2', title: 'Moonlight Sonata (1º mov.)', artist: 'Beethoven', bpm: 60, driveId: '1adhCCG_AgImaYOayJnDaEVZiwUppEsvW', evidence: 'Domínio público' },
    { id: 'sono-3', title: 'Gymnopédie No. 1', artist: 'Satie', bpm: 60, driveId: '1JlwlykUX_AboSW8ZexqIYKHzwqU0-fte', evidence: 'Domínio público' },
    { id: 'sono-4', title: 'Nocturne Op. 9 No. 2', artist: 'Chopin', bpm: 65, driveId: '1wEkGwISmn09m5ZyqEEoGrVcJIbQWlnZT', evidence: 'Domínio público' },
  ],
  TAG: [
    { id: 'tag-1', title: 'Gymnopédie No. 1', artist: 'Satie', bpm: 60, driveId: '1JlwlykUX_AboSW8ZexqIYKHzwqU0-fte', evidence: 'Domínio público' },
    { id: 'tag-2', title: 'Clair de Lune', artist: 'Debussy', bpm: 50, driveId: '1IcvqZbYMc50TF08Yewkn-qKc4-eFL0sr', evidence: 'Domínio público' },
    { id: 'tag-3', title: 'Weightless', artist: 'Marconi Union', bpm: 60, external: EXTERNAL_LINKS.weightless, evidence: 'Link externo' },
    { id: 'tag-4', title: 'Spiegel im Spiegel', artist: 'Arvo Pärt', bpm: 70, external: EXTERNAL_LINKS.spiegel, evidence: 'Link externo' },
  ],
  TP: [
    { id: 'tp-1', title: 'Gymnopédie No. 1', artist: 'Satie', bpm: 60, driveId: '1JlwlykUX_AboSW8ZexqIYKHzwqU0-fte', evidence: 'Domínio público' },
    { id: 'tp-2', title: 'Gnossienne No. 1', artist: 'Satie', bpm: 55, driveId: '1_DSNqY14ro8XvzJ-I3PMw-u-YvPf0rtz', evidence: 'Domínio público' },
    { id: 'tp-3', title: 'Moonlight Sonata (1º mov.)', artist: 'Beethoven', bpm: 60, driveId: '1adhCCG_AgImaYOayJnDaEVZiwUppEsvW', evidence: 'Domínio público' },
    { id: 'tp-4', title: 'Weightless', artist: 'Marconi Union', bpm: 60, external: EXTERNAL_LINKS.weightless, evidence: 'Link externo' },
  ],
  TDAH: [
    { id: 'tdah-1', title: 'Gymnopédie No. 1', artist: 'Satie', bpm: 60, driveId: '1JlwlykUX_AboSW8ZexqIYKHzwqU0-fte', evidence: 'Domínio público' },
    { id: 'tdah-2', title: 'Concerto p/ Piano No. 21 (Andante)', artist: 'Mozart', bpm: 78, driveId: '1SLyDDyLcHqgX2ilOKNIVVowd5dSCpiK0', evidence: 'Domínio público' },
    { id: 'tdah-3', title: 'Clair de Lune', artist: 'Debussy', bpm: 50, driveId: '1IcvqZbYMc50TF08Yewkn-qKc4-eFL0sr', evidence: 'Domínio público' },
    { id: 'tdah-4', title: 'Weightless', artist: 'Marconi Union', bpm: 60, external: EXTERNAL_LINKS.weightless, evidence: 'Link externo' },
  ],
  ESTRESSE: [
    { id: 'estresse-1', title: 'Gymnopédie No. 1', artist: 'Satie', bpm: 60, driveId: '1JlwlykUX_AboSW8ZexqIYKHzwqU0-fte', evidence: 'Domínio público' },
    { id: 'estresse-2', title: 'Moonlight Sonata (1º mov.)', artist: 'Beethoven', bpm: 60, driveId: '1adhCCG_AgImaYOayJnDaEVZiwUppEsvW', evidence: 'Domínio público' },
    { id: 'estresse-3', title: 'Weightless', artist: 'Marconi Union', bpm: 60, external: EXTERNAL_LINKS.weightless, evidence: 'Link externo' },
    { id: 'estresse-4', title: 'Spiegel im Spiegel', artist: 'Arvo Pärt', bpm: 70, external: EXTERNAL_LINKS.spiegel, evidence: 'Link externo' },
  ],
};
    ...
    <View style={styles.card}>
      ...
      {isPlaying && (
        <TouchableOpacity style={styles.stopButton} onPress={stopPlayback} activeOpacity={0.7}>
          <Text style={styles.stopButtonText}>⏹ Parar reprodução</Text>
        </TouchableOpacity>
      )}
    </View>
  );
      ...
      <View key={item.id} style={[styles.card, isCurrent && styles.cardPlaying]}>
        <View style={styles.songHeader}>
          <View style={styles.songInfo}>
            ...
            <Text style={styles.songArtist}>{item.artist} • ~{item.bpm} BPM</Text>
          </View>
          {isCurrent && (
        ...
        <View style={styles.actions}>
          {isPublic ? (
            <TouchableOpacity onPress={() => playTrack(item)} style={[styles.actionButton, styles.playButton]} activeOpacity={0.8}>
              <Text style={styles.actionButtonText}>{isCurrent ? '▶ Tocando' : '▶ Tocar'}</Text>
            </TouchableOpacity>
          ) : (
            <>
    ...
    <LinearGradient colors={['#0a0e27', '#1a1040']} style={styles.container}>
      <SafeAreaView style={[styles.safeArea, { paddingTop: insets.top }]}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: insets.bottom + 20 }}>
          ...
          <Text style={styles.headerSubtitle}>Selecione o perfil e a música</Text>
          {renderTabs()}
          {render8DCard()}
          <Text style={styles.sectionTitle}>Músicas para {activeProfileConfig.label}</Text>
